...
import (
	...
	"github.com/sandesPathak/career-ops/dashboard/internal/data"
	"github.com/sandesPathak/career-ops/dashboard/internal/model"
	"github.com/sandesPathak/career-ops/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("career-ops by github.com/sandesPathak")
