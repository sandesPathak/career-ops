...
const CANONICAL_REPO = 'https://github.com/sandesPathak/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/sandesPathak/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/sandesPathak/career-ops/releases/latest';
